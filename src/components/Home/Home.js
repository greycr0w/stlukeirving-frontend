...
class Home extends Component {
    ...
    render() {
        ...
        <section className="sa-place-section pd-default-3 text-center">
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-lg-7">
                        <div className="sa-section-title text-center">
                            <h2>Best Religious Places</h2>
                ...
                <div className="row justify-content-center">
                    <div className="col-lg-3 col-md-4">
                        <div className="sa-place-single">
                            <img src="assets/images/place/place-1.jpg" alt=""></img>
                            <div className="sa-place-info">
                                <h2>Cathedral interior</h2>
                                <p>View on Maps</p>
                                <a className="sa-btn-transparent" href="home-4.html">Details <i className="fa fa-caret-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-3 col-md-4">
                        <div className="sa-place-single">
                            <img src="assets/images/place/place-2.jpg" alt=""></img>
                            <div className="sa-place-info">
                                <h2>Interior Church</h2>
                                <p>View on Maps</p>
                                <a className="sa-btn-transparent" href="home-4.html">Details <i className="fa fa-caret-right"></i></a>
                            </div>
                        </div>
                    ...
                    <div className="col-lg-3 col-md-4">
                        <div className="sa-place-single">
                            <img src="assets/images/place/place-3.jpg" alt=""></img>
                            <div className="sa-place-info">
                                <h2>Cathedral Front</h2>
                                <p>View on Maps</p>
                                <a className="sa-btn-transparent" href="home-4.html">Details <i className="fa fa-caret-right"></i></a>
                            </div>
                        </div>
                    ...
                    <div className="col-lg-3 col-md-4">
                        <div className="sa-place-single">
                            <img src="assets/images/place/place-4.jpg" alt=""></img>
                            <div className="sa-place-info">
                                <h2>Building Surrounded</h2>
                                <p>View on Maps</p>
                                <a className="sa-btn-transparent" href="home-4.html">Details <i className="fa fa-caret-right"></i></a>
                            </div>
                        </div>
                    ...
                    <div className="col-lg-3 col-md-4">
                        <div className="sa-place-single">
                            <img src="assets/images/place/place-5.jpg" alt=""></img>
                            <div className="sa-place-info">
                                <h2>Stone Sathedrin</h2>
                                <p>View on Maps</p>
                                <a className="sa-btn-transparent" href="home-4.html">Details <i className="fa fa-caret-right"></i></a>
                            </div>
                        </div>
                    ...
                    <div className="col-lg-3 col-md-4">
                        <div className="sa-place-single">
                            <img src="assets/images/place/place-7.jpg" alt=""></img>
                            <div className="sa-place-info">
                                <h2>Nature Poient</h2>
                                <p>View on Maps</p>
                                <a className="sa-btn-transparent" href="home-4.html">Details <i className="fa fa-caret-right"></i></a>
                    ...
                    <div className="col-lg-3 col-md-4">
                        <div className="sa-place-single">
                            <img src="assets/images/place/place-8.jpg" alt=""></img>
                            <div className="sa-place-info">
                                <h2>Brown Beige Church</h2>
                                <p>View on Maps</p>
                                <a className="sa-btn-transparent" href="home-4.html">Details <i className="fa fa-caret-right"></i></a>
                            </div>
                        </div>
